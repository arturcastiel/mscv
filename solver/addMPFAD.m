...
for index=1:size(oneNodeEdges,1)
    ...
    M(inedge(iface,3), inedge(iface,3))=M(inedge(iface,3), inedge(iface,3))- mobility(iface+size(bedge,1),region)* Kde(iface);
    M(inedge(iface,3), inedge(iface,4))=M(inedge(iface,3), inedge(iface,4))+ mobility(iface+size(bedge,1),region)* Kde(iface);
    M(inedge(iface,4), inedge(iface,4))=M(inedge(iface,4), inedge(iface,4))- mobility(iface+size(bedge,1),region)* Kde(iface);
    M(inedge(iface,4), inedge(iface,3))=M(inedge(iface,4), inedge(iface,3))+ mobility(iface+size(bedge,1),region)* Kde(iface);
