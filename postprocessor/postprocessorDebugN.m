...
function postprocessorDebugN(pressure,flowrate,watersaturation,oilsaturation,...
    step,overedgecoord,orderintimestep,keywrite,invh,normk,name)
...
fname_vtk = name;
formatSpec = '%8.3d\n';
fname = [fname_vtk, num2str(step, formatSpec), '.vtk'];

%fname_vtk = 'result.vtk';
fid = fopen(fname,'w');
...
fprintf(fid,'SCALARS Pressure double 1 \r\n');
...
if numcase > 30
    ...
    fprintf(fid,'SCALARS WaterSaturation double 1 \r\n');
    fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
    fprintf(fid,'%26.16E \r\n',watersaturation);
    %Jump a line
    fprintf(fid,'\r\n');
    ...
    fprintf(fid,'SCALARS OilSaturation double 1 \r\n');
    fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
    fprintf(fid,'%26.16E \r\n',oilsaturation);
    %Jump a line
    fprintf(fid,'\r\n');
    ...
    fprintf(fid,'SCALARS Order double 1 \r\n');
    fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
    fprintf(fid,'%26.16E \r\n',orderintimestep);
    %Jump a line
    fprintf(fid,'\r\n');
...
if numcase > 0 && numcase < 20
    ...
    fprintf(fid,'SCALARS AnalitPressure double 1 \r\n');
    fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
    fprintf(fid,'%26.16E \r\n',presanalit);
    %Jump a line
    fprintf(fid,'\r\n');
...
fprintf(fid,'SCALARS NormPermeability double 1 \r\n');
fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
fprintf(fid,'%26.16E \r\n',normk);
%Jump a line
fprintf(fid,'\r\n');
...
if numcase > 0 && numcase < 30
    ...
    %Write data related to Absolute ERROR
    fprintf(fid,'SCALARS AbsPressureERROR double 1 \r\n');
    fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
    fprintf(fid,'%26.16E \r\n',presserrorfield);
    %Jump a line
    fprintf(fid,'\r\n');
