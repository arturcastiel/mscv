...
function postprocessorTMS2(pressure,watersaturation,step,folder,flag)
global coord elem
%--------------------------------------------------------------------------
...
%First file name
if flag == 0
    fname = 'VPI-Snapshot-Original';
else
    fname = 'VPI-Snapshot-Multiscale';
end
...
fname_vtk = [folder fname '00' step ext];
...
fprintf(fid,'SCALARS PressureOriginal double 1 \r\n');
...
%fprintf(fid,'CELL_DATA %i \r\n',nelem);
%Write data related to PRESSURE
fprintf(fid,'SCALARS SaturarionOriginal double 1 \r\n');
fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
fprintf(fid,'%26.16E \r\n',watersaturation);
%Jump a line
fprintf(fid,'\r\n');
...
%     fprintf(fid,'SCALARS Courant double 1 \r\n');
%     fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
%     fprintf(fid,'%26.16E \r\n',courantbyelem);
%     %Jump a line
%     fprintf(fid,'\r\n');
