...
function postprocessorTM(coarse,watersaturation,folder)
global coord elem
%--------------------------------------------------------------------------
...
%Write data related to Coarse Region
fprintf(fid,'SCALARS Coarse double 1 \r\n');
...
fprintf(fid,'SCALARS InteractionRegion double 1 \r\n');
fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
fprintf(fid,'%26.16E \r\n',watersaturation);
%Jump a line
fprintf(fid,'\r\n');
